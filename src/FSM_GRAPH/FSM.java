...
public class FSM {
	...
	// tim tat ca transition bat dau bang mot state cho truoc
	...
	//Lay tat ca cac transition ket thuc bang state
	...
	public ListTransitionSequence conVertFromPath(ThePath PATH){
		...
		//Chuyen cac path thanh cac transition tuong ung dua vao beginstate va endstate
