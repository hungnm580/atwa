...
public class ThePath {
	...
	/**
	 * Tap cac duong di, voi moi duong di la mot danh sach cac state (dai dien bang index cua state)
	 */
	...
	public void sort(){
		// Sap xep tap cac duong di tu nho toi lon theo size
		...
		//Remove neu mot duong di la con cua duong di khac
		for (int i=0; i< arrPath.size()-1; i++){
			for (int j=i+1; j<arrPath.size(); j++){
	...
	//Kiem tra neu mot duong di la con cua duong di khac
