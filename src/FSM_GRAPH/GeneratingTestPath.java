...
public class GeneratingTestPath {
	...
	boolean [][] isUsed; //Mang 2 chieu [numberStates][numberStates]
	String [][] nameTransition; //Mang 2 chieu [numberStates][numberStates]
	ArrayTransList[][] arrTranLists; //Mang 2 chieu [numberStates][numberStates]
	int numberStates; // So luong state
	...
	public GeneratingTestPath(FSM fsm){
		...
		//Them cac end state vao danh sach
		...
		//In toan bo mot day cac transition
		for (int i=0; i<numberStates; i++){
			for (int j=0; j<numberStates; j++){
	...
	// Them state vao sau state i cho toi khi gap end state
